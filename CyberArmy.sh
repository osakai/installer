...
echo -e  "Tools    : Mr.0b1tr0n $white         " |lolcat
echo -e  "Team     : CACACRACK Team $white   " |lolcat
echo -e  "Contacta : azis28179@gmail.com $white " |lolcat
echo -e  "_____________________________________________________________"
...
6) echo "created by : Mr.0b1tr0n" | lolcat
exit
;;
